...
/* Standard interface: BackupKey, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO BackupKey_ProxyInfo;
    ...
    /* [in] */ DWORD dwParam)
{
    ...
    _RetVal = NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&BackupKey_ProxyInfo,
                  0,
                  0,
                  h,
                  pguidActionAgent,
...
static const MIDL_STUB_DESC BackupKey_StubDesc = 
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& BackupKey_ProxyInfo,   /* proxy/server info */
    0
    };
...
static const MIDL_STUBLESS_PROXY_INFO BackupKey_ProxyInfo =
    {
    &BackupKey_StubDesc,
    ms2Dbkrp__MIDL_ProcFormatString.Format,
    BackupKey_FormatStringOffsetTable,
